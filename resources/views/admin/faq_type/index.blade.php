            ...
            <div class="card-header">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="card-title">
                        ...
                        <h3 style="color:green">Faq Type Management</h3>
                    ...
                    <tbody>
                        ...
                        @foreach ($faqs as $faq)
                            <tr>
                                ...
                                <td>{{ $faq->section_type ?? '' }}</td>

                                <td>
                                    <a href="{{ route('faq_status_type', ['id' => $faq->id]) }}">
                                        @if ($faq->status == 1)
                                ...
                                <td>
                                    <div class="form-button-action">
                                        ...
                                        <a href="{{ route('edit_faq_type', ['id' => $faq->id]) }}">
                                        ...
                                        <a href="{{ route('faq_type_delete', ['id' => $faq->id]) }}"
