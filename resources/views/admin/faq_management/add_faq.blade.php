    ...
    <div class="row">
        <div class="col-lg-8">
                ...
                <label>FAQ Type</label>
                    <select class="form-control" name="faq_type_id">
                        @foreach ($faq_type  as $faq_types )
                            <option value="{{ $faq_types->id }}">{{ ucwords($faq_types->section_type) }}</option>
                        @endforeach
            ...
            <div class="form-group">
                ...
                <input type="text" name="question" class="form-control" value="{{ old('question') }}" placeholder="Enter Question">
