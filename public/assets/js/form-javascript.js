    ...
    if (x < max_fields) { //max input box allowed
      ...
      $(wrapper).find('.medi-inputs').append(
                  ...
                  <div class="mb-4 mt-4 form-group">
                      <input type="text" placeholder="Name of Medication" name="m_name_${x}"
                          class="form-control py-3" id="">
                  </div>
                  <div class="mb-4 form-group">
                      <input type="text" placeholder="Dosage" name="m_dosage_${x}"
                          class="form-control py-3" id="">
                  </div>
                  <div class="mb-4 form-group">
                      <input type="text" placeholder="Frequency" name="m_frequency_${x}"
...
$(document).ready(function () {
  ...
  $(add_button).click(function (e) { //on add input button click
    ...
    if (x < max_fields) { //max input box allowed
      x++; //text box increment
      $(wrapper).append(`<div class="mb-3 mt-3 d-flex" ><div class="mt-4"><input type="radio" class="form-check-input" value="divorce" name="divorce_death_${x}" id="prior-divorce${x}"><label class="form-check-label pr-5" for="prior-divorce${x}">Divorce</label><input type="radio" class="form-check-input" value="death" id="death-no${x}" name="divorce_death_${x}"><label class="form-check-label" for="death-no${x}">Death</label></div><input type="date" class="form-control py-3" name="divorce_or_death_date[]"/>&nbsp;<a href="javascript:void(0);" class="btn-danger deleteClass remove_field text-center"><i class="fa fa-minus"></i></a></div>`); //add input box
    }
  });
    ...
    if (x < max_fields) { //max input box allowed
      ...
      $(wrapper).find('.more-children-wrap').append(
                  ...
                  <div class="form-group mb-4">
                      <input type="text" placeholder="Name of Child" name="name_child_${x}"
                          class="form-control py-3" id="">
                  </div>
                  <div class="form-group mb-4">
                      <input type="number" placeholder="Age of Child" name="age_of_child_${x}"
                          class="form-control py-3" id="">
                  </div>
                  <div class="form-group mb-4">
                      <select class="form-select py-3" id="" name="relationship_with_child_${x}">
                          <option disabled value="">Relationship With Child
                          </option>
    ...
    $(add_button).click(function (e) { //on add input button click
      ...
      if (x < max_fields) { //max input box allowed
        ...
        $(wrapper).find('.more-siblings-wrap').append(
            ...
            <div class="mb-4 form-group">
            <select class="form-select py-3" id="" name="sibling_relation[]">
                <option disabled value="">Relationship with Sibling
                </option>
...
document.getElementById('signbox-date').innerHTML = n + ' ' + time;
console.log('date:', n);
console.log('time:',time);

var today = new Date();

var time_s = today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds();
console.log(time_s)